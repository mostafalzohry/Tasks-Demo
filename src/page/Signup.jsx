      ...
      <section>
        <div className='grid h-screen md:grid-cols-2  '>
          <div className='mx-auto w-4/5 md:w-full '>
            <div className='mx-auto flex  h-screen flex-col justify-center md:w-4/5 '>
              <div>
                <div>
                  ...
                  <h2 className='text-center text-sm tracking-tight text-gray-900 text-white md:text-xs'>
                    Are you new? Sign up today
                  </h2>
                </div>

                <div className='mt-4 text-xs' style={{ color: 'white' }}>
                  {errors && errors}
                </div>
              ...
              <p className='mt-10 text-center text-sm text-white'>
                ...
                <NavLink to='/' className='text-tertiary underline'>
                  Sign in
                </NavLink>
              </p>
            </div>
          ...
          <div className='bg-sidebar hidden h-screen md:block'>
            <div
